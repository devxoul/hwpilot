...
import { editFormatCommand } from '@/cli/commands/edit-format'
import { editTextCommand } from '@/cli/commands/edit-text'
import { findCommand } from '@/cli/commands/find'
import { imageExtractCommand, imageInsertCommand, imageListCommand, imageReplaceCommand } from '@/cli/commands/image'
import { paragraphAddCommand } from '@/cli/commands/paragraph'
import { readCommand } from '@/cli/commands/read'
import { tableAddCommand, tableEditCommand, tableListCommand, tableReadCommand } from '@/cli/commands/table'
import { textCommand } from '@/cli/commands/text'
